...
public class GF256 {
    ...
    public static byte mul(byte a, byte b) {
        return a != 0 && b != 0 ? EXP[Byte.toUnsignedInt(LOG[Byte.toUnsignedInt(a)]) + Byte.toUnsignedInt(LOG[Byte.toUnsignedInt(b)])] : 0;
    }

    public static byte div(byte a, byte b) {
        return mul(a, EXP[255 - Byte.toUnsignedInt(LOG[Byte.toUnsignedInt(b)])]);
    }
    ...
    public static byte interpolate(byte[][] points) {
        ...
        for(int i = 0; i < points.length; ++i) {
            ...
            for(int j = 0; j < points.length; ++j) {
                byte bX = points[j][0];
                if (i != j) {
                    li = mul(li, div(sub((byte)0, bX), sub(aX, bX)));
                }
            }
