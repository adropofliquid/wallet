package com.adropofliquid.secretshare.shamir;

import java.security.SecureRandom;
import java.util.*;

/*Modification of the original @ https://github.com/codahale/shamir
* made join() static, no need for new Scheme instance
* */
